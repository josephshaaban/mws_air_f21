...
class Bootstrap4(template.Node, metaclass=MediaDefiningClass):
    ...
    class Media:  # pylint: disable=R0903
        ...
        js = [
            'bootstrap/bootstrap-4.3.1-dist/js/bootstrap.bundle.min.js',
        ]
...
class JQuery(template.Node, metaclass=MediaDefiningClass):
    ...
    class Media:  # pylint: disable=R0903
        ...
        js = [
            'jquery_core/jquery-3.4.1-dist/jquery.min.js',
        ]
...
class JQueryUI(template.Node, metaclass=MediaDefiningClass):
    ...
    class Media:  # pylint: disable=R0903
        ...
        css = {
            'all': [
                'jquery_ui/jquery-ui-1.12.1/jquery-ui.min.css',
                # 'jquery_ui/jquery-ui-1.12.1/jquery-ui.structure.min.css',
                # 'jquery_ui/jquery-ui-1.12.1/jquery-ui.theme.min.css',
            ]
        }
        js = [
            'jquery_ui/jquery-ui-1.12.1/jquery-ui.min.js',
        ]
